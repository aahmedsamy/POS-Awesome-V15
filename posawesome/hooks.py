...
# Reinstall POS Awesome custom fields on every migrate.
after_migrate = "posawesome.migrate.reset_custom_fields_on_migrate"
        ...
        "filters": [
            [
                ...
                (
                    ...
                    "POS Profile-posa_pos_awesome_invoice_settings",
                    "POS Profile-posa_invoice_column_break_1",
                    "POS Profile-posa_invoice_column_break_2",
                    "POS Profile-posa_pos_awesome_purchase_order_settings",
                    "POS Profile-posa_purchase_order_column_break_1",
                    "POS Profile-posa_purchase_order_column_break_2",
                    "POS Profile-posa_pos_awesome_sales_order_settings",
                    "POS Profile-posa_sales_order_column_break_1",
                    "POS Profile-posa_sales_order_column_break_2",
                    "POS Profile-posa_pos_awesome_pricing_discount_settings",
                    "POS Profile-posa_pricing_discount_column_break_1",
                    "POS Profile-posa_pricing_discount_column_break_2",
                    "POS Profile-posa_pos_awesome_invoice_return_settings",
                    "POS Profile-posa_invoice_return_column_break_1",
                    "POS Profile-posa_invoice_return_column_break_2",
